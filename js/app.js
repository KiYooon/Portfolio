		...
		$scope.dataSource = [
			{
			 ...
			 type : true, 
			 contents: "교육기관에 들어와 처음 해보는 프로젝트였고, 게다가 팀프로젝트여서 상당히 부담감을 느꼈습니다. 팀원들과 역할 분담을 나누는 것오 가장 어려웠고 의견을 받는 부분도 많은 어려움을 느꼈습니다. 하지만 4명의 팀원들이 저를 많이 도와준 덕분에 프로젝트를 성공적으로 마치게 되었고 저에게는 한걸음 더 성장할 수 있는 계기가 되었고 많은 것을 느낄 수 있었던 좋은 경험이었습니다."
			},{
			 path: "portfolio/",
